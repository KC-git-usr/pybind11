...
print("Result of sum = ", kpl.python_adder_fn(1.5, 2.5))

# calling our templated cpp function in python
print("Output of templated cpp function is = ", kpl.py_foo_float_to_int([1, 2, 3]))

# creating a python object of the exposed cpp class and constructor
my_obj = kpl.PySomeClass(5)
...
with ThreadPoolExecutor(4) as ex:
    ex.map(lambda x: kpl.py_function_that_takes_a_while(), [None] * 4)
